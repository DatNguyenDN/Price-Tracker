...
const VerifyForm = () => {
  const { data,token,setToken,responseData, } = useSignUpContext();
  ...
  return (
    <section className="max-w-2xl px-6 py-8 mx-auto bg-white dark:bg-gray-900">
        ...
        <main className="mt-8">
          <h2 className="text-gray-700 dark:text-gray-200">Hi {setToken}</h2>
          
          <p className="mt-2 leading-loose text-gray-600 dark:text-gray-300">
            This is your verification code: {responseData.token} {responseData.email}
          </p>
